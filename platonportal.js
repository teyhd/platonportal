...
app.get('/balalayka', (req, res) => {
  ...
  const heroHighlights = [
    ...
    { value: 'Live', label: 'Комнаты открываются рядом с обсуждением.' }
  ];

  const proofPoints = [
    { title: 'Меньше шума', text: 'Важные сообщения легче заметить, когда чаты, темы и уведомления не смешиваются.' },
  ...
  const showcaseItems = [
    {
      ...
      label: 'Темы',
      eyebrow: 'Обсуждения',
      title: 'Разбирайте большие обсуждения по понятным темам.',
      ...
      points: [
        ...
        'комнату можно открыть из нужной темы'
      ]
    },
    {
      id: 'reactions',
    ...
    },
    {
      ...
      title: 'Делитесь фото, видео, документами и маршрутами.',
      ...
      points: [
        ...
        'маршрут открывается прямо из сообщения'
      ]
    },
    {
      id: 'notifications',
  ...
  const updateCards = [
    {
      eyebrow: 'Темы',
      title: 'Темы стало проще разбирать.',
      text: 'Перед входом в большой чат видно, где идет обсуждение и где появились новые сообщения.'
    },
    {
      eyebrow: 'Медиа',
    ...
    },
    {
      ...
      title: 'Меньше лишних уведомлений.',
